...
function angkaPalindrome(num) {
    ...
    let element = num+1;
    for (let index = num; index != element; index++) {
        ...
        if(element <=9){
            ...
            if (element.toString()[0] == element.toString()[1]) {
                return element;
            }
        }

        else if(element <= 999){
            if (element.toString()[0] == element.toString()[2]) {
                return element;
            }
        }

        else if(element <= 9999){
            if (element.toString()[0] == element.toString()[3] && element.toString()[1] == element.toString()[2]) {
                return element;
            }
        }
        else {
            return "angka lebih dari 9999";
        }
        element += 1;
    }
  }
