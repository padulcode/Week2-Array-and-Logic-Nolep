...
function mengelompokkanAngka(arr) {
    ...
    const number3 = arr.filter(arr => arr % 3 == 0);
    const number2 = arr.filter(arr => arr % 2 == 1  && arr % 3 != 0);
    const number1 = arr.filter(arr => arr % 2 == 0  && arr % 2 != 1  && arr % 3 != 0);
    const hasil = [number1,number2,number3];
